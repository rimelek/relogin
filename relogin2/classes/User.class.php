 ...
 * <b>Login weblapja:</b> {@link http://rimelek.hu/meghivos-loginrendszer-r-e-login-v2-0 R.E. Login v2.0}
 *
 * @property int $T__users__userid Felhasználó azonosítója
 ...
 * @property string $T__users__useremail Felhasználó aktivált e-mail címe.
 * @property string $newsreadtime Mikor olvasott utoljára hírt.
 *					Lásd {@link System::getTimeStamp()}
 * @property int $T__profiles__userid Felhasználó azonosítója a profiles táblában
 ...
 * @property string $T__profiles__useremail Felhasználó e-mail címe a profiljában.
...
class User extends IsMySQLClass
{
	...
	{
		$email = empty($this->T__users__useremail) ? '' : $this->T__users__useremail;
